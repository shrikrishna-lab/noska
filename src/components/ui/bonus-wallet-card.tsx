...
// Pixel-perfect 5 distinct styled memojis matching Image 1:
// 1. Masked avatar (mint green background, dark skin, surgical mask)
// 2. Blonde avatar with pink cat-eye sunglasses (warm peach background)
// 3. Braided dreadlocks smiling avatar (coral pink background)
// 4. Turban avatar winking (warm beige/gold background)
// 5. Visor / cyberpunk avatar (electric blue/violet background)
...
export function BonusWalletCard({
  ...
  const handleClaim = (e: React.MouseEvent) => {
    ...
    setClaimed(true);
    onClaim?.();
    showNotification("✨ Bonus Claimed and deposited into your workspace balance!");
  };
  ...
  return (
    <div
      ...
      data-testid="bonus-wallet-card"
    >
      {/* Outer Card Container - Apple off-white / light slate rounded container */}
      <div className="relative overflow-hidden rounded-[26px] bg-[#F2F3F7] dark:bg-[#15161c] border border-black/[0.06] dark:border-white/10 shadow-[0_10px_30px_rgba(0,0,0,0.08)] p-3 pb-3">
        ...
        {/* Overlapping Memoji 3-Avatars Circle Row + Counter - Exactly Centered on boundary */}
        ...
        <div className="px-0.5 pb-2">
          ...
          <div className="flex items-center justify-between p-2 rounded-xl bg-white dark:bg-[#1e1f26] border border-neutral-200/50 dark:border-white/5 shadow-[0_2px_6px_rgba(0,0,0,0.03)]">
            <div className="flex items-center gap-2 min-w-0">
              {/* Iridescent Purple/Pink Wireframe Sphere */}
