...
export const AGENT_TEMPLATES: AgentTemplate[] = [
  ...
  T("Study", {
    ...
    instructions: "Every run: find pages tagged 'study', pick the most relevant one, then use create_flashcards to generate 4-6 question cards from its content (front = clear question, answer = precise answer). Cards automatically enter Noska's spaced-repetition review queue.",
