...
const PROVIDERS: IntegrationProviderDefinition[] = [
  ...
  },
  {
    ...
    // Live: official Atlassian Rovo MCP (https://mcp.atlassian.com/v2/mcp),
    // OAuth login via dynamic client registration — no setup needed.
    status: "live",
  ...
  },
  {
    ...
    // Live: official GitLab MCP (https://gitlab.com/api/v4/mcp),
    // OAuth login via dynamic client registration — no setup needed.
    status: "live",
  ...
  },
  {
    ...
    // Live: gateway catalog row `linear` serves the official hosted MCP
    // server (https://mcp.linear.app/mcp) with token + OAuth DCR login.
    status: "live",
  ...
  },
  {
    ...
    // Live: official Figma remote MCP (https://mcp.figma.com/mcp),
    // OAuth login via dynamic client registration — no setup needed.
    status: "live",
  ...
  },
  {
    ...
    slug: "google-sheets",
    name: "Google Sheets",
    description: "Read, write, and append rows in Google Sheets spreadsheets without leaving Noska.",
    category: "File Management",
    icon: "google-sheets",
    brandColor: "#0F9D58",
    aliases: ["google", "sheets", "spreadsheet", "cells", "rows", "tabs", "gsheets"],
    capabilities: {
      oauth: true,
      token: false,
      multiAccount: true,
    ...
    authModes: ["oauth"],
    permissions: [
      "View and edit spreadsheet contents",
      "Spreadsheet metadata and sheet structure",
    ],
    // Live: official Sheets MCP (https://sheetsmcp.googleapis.com/mcp/v1),
    // same "Noska Auth" GCP OAuth client as Gmail/Calendar/Drive.
    status: "live",
  ...
  },
  {
    ...
    slug: "confluence",
    name: "Confluence",
    description: "Search spaces, read pages, and reference Confluence Cloud docs directly in your notes.",
    category: "Productivity",
    icon: "confluence",
    brandColor: "#172B4D",
    aliases: ["wiki", "docs", "documentation", "page", "space", "atlassian", "knowledge", "confluence"],
    capabilities: {
      oauth: true,
      token: false,
      multiAccount: true,
    ...
    authModes: ["oauth"],
    permissions: [
      "Space and page read access",
      "Page content and comments",
      "Search across your Confluence site",
    ],
    // Live: official Atlassian Rovo MCP (https://mcp.atlassian.com/v2/mcp),
    // OAuth login via dynamic client registration — no setup needed.
    status: "live",
  ...
  },
  {
    ...
    slug: "vercel",
    name: "Vercel",
    description: "Inspect Vercel projects, deployments, and settings without leaving Noska.",
    category: "Engineering",
    icon: "vercel",
    brandColor: "#000000",
    aliases: ["deploy", "deployment", "hosting", "preview", "project", "domain", "vercel"],
    capabilities: {
      oauth: true,
      token: false,
      multiAccount: true,
    ...
    // Live: official Vercel MCP (https://mcp.vercel.com),
    // OAuth login via dynamic client registration — no setup needed.
    status: "live",
  ...
  },
  {
    ...
    slug: "sentry",
    name: "Sentry",
    description: "Search Sentry errors, triage issues, and link stack traces from your workspace.",
    category: "Engineering",
    icon: "sentry",
    brandColor: "#362D59",
    aliases: ["error", "exception", "bug", "crash", "monitoring", "issue", "stacktrace", "performance", "sentry"],
    capabilities: {
      oauth: true,
      token: false,
      multiAccount: true,
    ...
    authModes: ["oauth"],
    permissions: [
      "Organization, project, and issue read access",
      "Error events and stack traces",
    ],
    // Live: official Sentry MCP (https://mcp.sentry.dev/mcp),
    // OAuth login via dynamic client registration — no setup needed.
    status: "live",
