...
// Runtime-aware shell for marketing routes. On the web these render the
// public site; in the desktop app they hand over to <App />, which resolves
// auth and lands the user on /login or their last workspace/page â€” the
// desktop client never intentionally shows the marketing site.
