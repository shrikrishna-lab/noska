...
export function SystemStatus() {
  ...
  const components = [
    ...
    { name: "Database", value: 99.9, unit: "% uptime", status: "operational", desc: "Postgres health" },
    { name: "API", value: 99.97, unit: "% uptime", status: "operational", desc: "API response rate" },
